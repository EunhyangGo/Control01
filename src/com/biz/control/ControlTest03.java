...
public class ControlTest03 {
	...
	public static void main(String[] args) {
		...
		// intMode == 0 의 결과가 false이면 위 문을 건너 뛴다.
		
		// if(intMode ===1) { 오차가 생겨 오류가 발생할수도 있기때문에 '!='을 사용해야됨.
		// intMode는 0아니면 1인 값을 당연히 갖는다라고 생각하지만
		// 어떤 불가항력적인 이유로 0과 1이 아닌 값을 가질 수 있다.
		// 그래서 기준이 되는 intMode == 0이라는 식의 반대되는 개념은 intMode == 1이 아닌
